...
class RestClient {
   ...
   *
   * You MAY:
   * - Override function *getRequestHeaders*. By default the list of headers returned by *getRequestHeaders* function
   *   will be added to all requests sent to the server. One of this header is the *Authorization* header which holds
   *   the access token
   *
   * @class RestClient
   * @constructor
